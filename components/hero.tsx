  ...
  return (
    <div className="flex flex-col h-svh justify-center items-center px-4">
      ...
      <div className="text-center relative z-10 w-full max-w-4xl mx-auto">
        ...
        <p className="text-sm sm:text-base text-white mt-6 sm:mt-8 max-w-[640px] mx-auto">Chain-agnostic trust and compliance infrastructure for Sharia-compliant Web3</p>
